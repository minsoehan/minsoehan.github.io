...
But I am not a vary advanced user. I usually don't need to edit this and that.
I just need to install and update AUR package. There are AUR Helpers out there.
They are very advanced and complicated to me. So I wrote the following script for my personal use.
...
[The direct link to the script.](https://github.com/minsoehan/mshii/blob/main/mur)
```bash
#!/bin/dash
